...
import io.pivotal.microservices.services.registration.RegistrationServer1;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		} else if (serverName.equals("registration1") || serverName.equals("reg1")) {
			RegistrationServer1.main(args);
